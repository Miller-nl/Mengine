...
PrMan = ProcessesManager(process_name='Тест МСК', session_name='Тест по IDSI')
...
geo = {'city_id': 1, 'geo_mask_value': 'москва', 'geo_mask_mapping': 'no_total_mapping'}
...
def count_url(element: GeneratedObject):
    if True:
        return ''  # Для закрытия нижней части

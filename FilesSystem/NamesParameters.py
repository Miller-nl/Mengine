'''
Эти функции используются для добавления параметро в имя файла и их извлечение.
    Дополнительно в имя можгут быть вставлены дата и время, что исключит дублирования.
'''
